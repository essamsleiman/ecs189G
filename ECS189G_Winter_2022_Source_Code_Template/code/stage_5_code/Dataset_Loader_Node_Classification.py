...
class Dataset_Loader(dataset):
    ...
    #     #print("ESSAM")
    #     # for i in range(0, len(self.data['graph']['X'][0])):
    #     #     print(self.data['graph']['X'][0][i])
      
    #     # self.data['graph']['edge'][0] = self.data['graph']['edge'][0][idx]
    #     # self.data['graph']['edge'][1] = self.data['graph']['edge'][1][idx]
    #     # self.data['graph']['X'] = self.data['graph']['X'][idx]
    #     # print("UTILITY: ", (self.data['graph']['node']))
    #     #print(len(self.data['graph']['y']))
    #     #row = self.data[idx]
    #     #print("ESSAM: ", row)
    ...
    #     # text = text_t
    #     print("ID:", idx)
    #     return self.data['x'][idx], self.data['edge_index'][idx]